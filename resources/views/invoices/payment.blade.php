                ...
                <tbody>
                  ...
                  @endif
                   ...
                   <tr>
                    ...
                    <td><b>{{ $invoice->currency_id == 2 ? 'USD $' : 'TZs.' }} {{number_format(($invoice->withholding_tax),2,'.',',')}} </b></td>
                  </tr>
