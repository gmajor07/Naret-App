    ...
    <div class="container-fluid">
            ...
            <div class="card card-default ">
                <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-cart-plus"></i>   Casual Labour Order Details.</h3>
                          ...
                          <tbody>
                            @foreach($order->casual_labour as $casual_labour)
                                  <tr>
                                    ...
                                    <td> {{number_format(($casual_labour->administration_fee),'2','.',',')}} </td>
                                    <td> {{$casual_labour->quantity}}</td>
                                    <td> {{number_format((($casual_labour->labour_charge + $casual_labour->administration_fee) * $casual_labour->quantity ),'2','.',',')}} </td>
                                  </tr>
                            @endforeach
                            ...
                            <tr style="color: #dc3545;">
                                ...
                                <td></td>
                                <td></td>
                                <td><b>WITH HOLDING TAX 5%</b></td>
                                <td><b>Tzs. {{number_format(($order->invoice->withholding_tax),2,'.',',')}} </b></td>
                              </tr>
                             ...
                             <tr style="color: #28a745; font-weight: 700;">
                              ...
                              <tr style="color: #28a745; font-weight: 700;">
                                ...
                                <td></td>
                                <td><b>TOTAL</b></td>
                                <td><b>Tzs. {{number_format(($order->invoice->total_vat_exclusive),2,'.',',')}}</b></td>
                              </tr>
                           ...
                           @if ($order->invoice->payment_status == 1)
                            <tr>
                              ...
                              <td style="color: #0af144;"><b>Tzs. {{number_format(($order->invoice->amount_paid),2,'.',',')}}</b></td>
                              <td></td>
                              <td></td>
                            </tr>
                            <tr>
                              ...
                              <td style="color: #aa0404;"><b>Tzs. {{number_format(($order->invoice->amount_due),2,'.',',')}}</b></td>
                              <td></td>
                              <td></td>
                            </tr>
                            @endif
