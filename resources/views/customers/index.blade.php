...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-users"></i> Managing Customers </h3>
            <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#addCustomer"
                style="float:right;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal"
                                    data-target="#modal-edit{{ $customer->id }}"><i class="fas fa-edit fa-xs"></i> </button>
                                <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal"
                                    data-target="#modal-delete{{ $customer->id }}"><i class="fas fa-trash-alt">
                                    </i></button>
                            </td>
                        </tr>
                       <!-- delete modal -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header bg-danger">
                                        <h4 class="modal-title">Deleting {{$customer->name}} </h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p>Are you sure you want to delete <b> {{$customer->name}}  </b> permanently? </p>
                        ...
                        <div class="modal fade" id="modal-edit{{$customer->id}}">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form role="form" method="post" action="{{route('customers.update',$customer->id)}}" id="activityForm">
                                        @csrf
                                        @method('PATCH')
                                        <div class="modal-header bg-primary">
                                            <h4 class="modal-title">Editing User {{ $customer->name }} </h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tin" class="form-control" value="{{ $customer->tin_number }}" placeholder="" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Vrn</label>
                                                        <input type="text" name="vrn" class="form-control" value="{{ $customer->vrn }}" placeholder="" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="location" class="form-control" value="{{ $customer->location }}" placeholder="" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="status" id="status">
                                                    @if($customer->status==1)
                                                    <option value="{{$customer->status}}" selected>Active</option>
                                                    @elseif ($customer->status==0)
                                                    <option value="{{$customer->status}}" selected>Not Active</option>
                                                    @endif
                                                    @if($customer->status==1)
    ...
    <div class="modal fade" id="addCustomer">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form role="form" method="post" action="{{route('customers.store')}}" id="activityForm">
                    @csrf
                    @method('POST')
                    <div class="modal-header bg-primary">
