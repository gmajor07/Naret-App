...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color: #3c8dbc;color:white;"><marquee>  <b>Change Password</b> - Choose a strong password</marquee></div>
                    ...
                    <form method="POST" action="{{ route('change') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn " style="background-color: #3c8dbc;color:white;">
