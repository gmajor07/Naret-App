...
<link rel="icon" type="image/jpeg" href="{{ asset('assets/img/naret.jpg') }}?v={{ filemtime(public_path('assets/img/naret.jpg')) }}">
<link rel="shortcut icon" type="image/jpeg" href="{{ asset('assets/img/naret.jpg') }}?v={{ filemtime(public_path('assets/img/naret.jpg')) }}">
<!-- Font Awesome -->
